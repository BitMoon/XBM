...
const string strMessageMagic = "Bitmoon Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	if(pindexBest->nHeight+1 == 1)
    {
        ...
        else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 5760)
    {
		    nSubsidy = 0 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bitmoon", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Bitmoon - 2016 Cryptocurrencies spread continue!";
        CTransaction txNew;
        txNew.nTime = 1467298404;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd084f97c942771cba3e904df02ff6debfe1ae172c728a75c6435afee8081ce7e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xc2, 0x7e, 0xab, 0xcc };
