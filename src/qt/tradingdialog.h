...
private slots:
    ...
    void on_BuyXBM_clicked();
    void on_SellXBMBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputXBM_textChanged(const QString &arg1);
    ...
    QString BuyXBM(QString OrderType, double Quantity, double Rate);
    QString SellXBM(QString OrderType, double Quantity, double Rate);
